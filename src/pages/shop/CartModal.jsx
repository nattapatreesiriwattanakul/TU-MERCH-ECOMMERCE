      ...
      >
        <div className="p-4 mt-4">
          <div className="flex justify-between items-center mb-4">
            ...
            >
              <i className="ri-close-large-line  bg-black p-1 text-white"></i>
            </button>
          </div>
          {/* cart Details */}
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        {Number(item.price).toFixed(2)} THB
                      </p>
                    </div>
                    <div className="flex flex-row md:justify-start justify-end items-center mt-2">
                      <button
                        onClick={() => handleQuantity("decrement", item.id)}
                        className="size-6 flex items-center justify-center px-1.5 rounded-full bg-gray-200 text-gray-700 hover:bg-primary-light hover:text-white ml-8"
                      >
                        -
                      </button>
                      ...
                      <button
                        ...
                        className="size-6 flex items-center justify-center px-1.5 rounded-full bg-gray-200 text-gray-700 hover:bg-primary-light hover:text-white"
                      >
                        +
                      </button>
                      <div className="ml-5">
